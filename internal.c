...
int json_to_csv(sqon_dbsrv *srv, json_t *in, char *out, size_t n,
...
static int insert(sqon_dbsrv *srv, json_t *in, char *out, size_t n)
{
    json_incref(in);
    int rc = 0;
